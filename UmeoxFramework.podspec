#
#  Be sure to run `pod spec lint UmeoxFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/XiaoWeiChung/UMEOXFramework"
  ...
  spec.author             = { "XiaoWeiChung" => "394980560@qq.com" }
  # Or just: spec.author    = "XiaoWeiChung"
  # spec.authors            = { "XiaoWeiChung" => "394980560@qq.com" }
  # spec.social_media_url   = "https://twitter.com/XiaoWeiChung"
